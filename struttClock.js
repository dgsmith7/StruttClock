...
function loadAssets() {
	...
	tcLoader.setPath('https://github.com/dgsmith7/StruttClock/tree/main/Assetts/textures/cube/polishedBrass/'); // pixels power of 2
	...
	for (const model of Object.values(models)) {
		loader.load('https://github.com/dgsmith7/StruttClock/tree/main/Assetts/models/orig' + model.fileName, function(object) {
